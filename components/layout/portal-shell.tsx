...
function getCurrentTitle(pathname: string, basePath: string) {
  ...
  const titleMap: Record<string, string> = {
    ...
    videos: "Vídeos Sistema Catedral",
    ...
    "academia-catedral": "Capacitação",
    "empreendedor-blindado": "Empreendedor Blindado",
    "videos-sistema-catedral": "Vídeos Sistema Catedral",
    ...
    return [
      ...
      },
      {
        ...
        items: [
          ...
          { label: "Capacitação", href: `${basePath}/treinamentos/capacitacao` },
          { label: "Vídeos Empreendedor Blindado", href: `${basePath}/treinamentos/empreendedor-blindado` },
          { label: "Vídeos Sistema Catedral", href: `${basePath}/treinamentos/videos` },
        ],
      },
      {
        id: "central",
